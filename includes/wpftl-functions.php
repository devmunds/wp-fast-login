...
if(!function_exists('wpftl_enqueue_scripts')){
    function wpftl_enqueue_scripts(){
        wp_enqueue_style('wpftl-login-style', '/wp-content/plugins/wp-fast-login/views/assets/css/wpftl-style.css', array(), '1.0.7', 'all');
        wp_enqueue_script('wpftl-login', '/wp-content/plugins/wp-fast-login/views/assets/js/wpftl-login.js', __FILE__,array('jquery'),'1.0.1', true);
    ...
    function wpftl_form_login(){
        ...
        $formHTML = '<form method="post" id="login">
                        <div class="form-control">
                            <input type="email" name="email" id="login_email" placeholder="Login">    
                        </div>
                        <div class="form-control">
                            <input type="password" name="password" id="login_password" placeholder="Senha">        
                        </div>
                        <div class="form-control">
